...
import { gnomeWeaponFocusCompendiumId, racialWeaponFocusKey, weaponFocusKey, WeaponFocusRacial } from "./_base-weapon-focus.mjs";
...
Hooks.on('renderItemSheet', (
    ...
    textInput({
        current,
        item,
        journal: WeaponFocusRacial.journal,
        key,
        parent: html,
    }, {
        canEdit: isEditable,
