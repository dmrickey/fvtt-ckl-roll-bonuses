...
## Virtual Size Bonus
Increase the value used by any sizeRoll formula in the target. (typically in the damage formula) Use with boolean flag `bonus_virtual-size`. This is useful for spells like Gravity Bow, Lead Blades, Strong Jaw, etc.
