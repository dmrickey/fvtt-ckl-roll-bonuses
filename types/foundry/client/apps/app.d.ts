...
declare global {
    ...
    > {
         ...
         */
        render(options?: Application.RenderOptions<Options>): unknown;
    ...
    namespace Application {
        ...
        type RenderOptions<
            Options extends ApplicationOptions = ApplicationOptions
        > = Partial<Options> & _RenderOptions;
        ...
        interface _RenderOptions {
            ...
            /**
             * Add the rendered application to the DOM if it is not already present. If
             * false, the Application will only be re-rendered if it is already present.
             * @defaultValue `false`
             */
            force?: boolean | undefined;
