...
type _ClassMustBeAssignableToInternal = MustConform<
    typeof ApplicationV2,
    ApplicationV2.Internal.Constructor
>;
type _InstanceMustBeAssignableToInternal = MustConform<
    ApplicationV2,
    ApplicationV2.Internal.Instance.Any
>;
...
declare global {
    declare namespace ApplicationV2 {
        ...
        export interface Configuration {
            ...
            actions: Record<
                string,
                ClickAction | { handler: ClickAction; buttons: number[] }
            >;
    ...
    > extends EventEmitterMixin(Object) {
        ...
        protected _renderHeaderControl(
            control: ApplicationV2.HeaderControlsEntry
        ): HTMLLIElement;
        ...
        changeTab(
            tab: string,
            group: string,
            options?: ApplicationV2.ChangeTabOptions
        ): void;
